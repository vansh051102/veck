...
-- CreateIndex
CREATE INDEX "AuditLog_orgId_resourceType_action_timestamp_idx" ON "AuditLog"("orgId", "resourceType", "action", "timestamp");
...
-- CreateIndex
CREATE INDEX "Lead_orgId_assignedToId_status_idx" ON "Lead"("orgId", "assignedToId", "status");
...
-- CreateIndex
CREATE INDEX "Activity_orgId_createdBy_createdAt_idx" ON "Activity"("orgId", "createdBy", "createdAt");

-- CreateIndex
CREATE INDEX "Activity_orgId_type_createdAt_idx" ON "Activity"("orgId", "type", "createdAt");
